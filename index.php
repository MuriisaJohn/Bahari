...
?>
		...
		<div class="section-margin-top" id="visit">
			...
			<div class="row reveal">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-xxs-12">
					<div class="tm-home-box-2">
						...
						<div class="tm-home-box-2-container">
							...
							<a href="contact/contact.php" class="tm-home-box-2-link"><span
									class="tm-home-box-2-description">Travel</span></a>
							<a href="contact/contact.php" class="tm-home-box-2-link"><i
			 ...
			 <div class="row">
				<div class="col-lg-12">
					<p class="home-description">Bahari is the travelling website which will guide you through out
				...
				<div class="col-lg-6">
					<div class="tm-home-box-3 reveal">
						...
						<div class="tm-home-box-3-info">
							...
							<div class="tm-home-box-2-container">
								<a href="ccontact/contact.php" class="tm-home-box-2-link"><i
										class="fa fa-heart tm-home-box-2-icon border-right"></i></a>
								<a href="contact/contact.php" class="tm-home-box-2-link"><span
										class="tm-home-box-2-description box-3">Travel</span></a>
								<a href="contact/contact.php" class="tm-home-box-2-link"><i
	...
	<footer>        
        <div class = "pages">
            <div class="menu-items">
				...
				<a href = "../admin_panel/sign in.html"><span class= "decor">Admin</span></a>
            </div>
        </div>
        <div class= "logo_bot">
            <!-- <img src = "img/sht.png"> -->
			...
			<div class="bottom-footer">
				...
				<p>Copyrights &copy <span id="copyrightYear">2023</span> Bahari Emperial | </p>
			</div>
        </div>
